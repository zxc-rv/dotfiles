...
local user_opts = {
    ...
    scalewindowed = 1.5,              	-- scaling of the controller when windowed (vidscale false 4K)
    scalefullscreen = 1.5,            	-- scaling of the controller when fullscreen (vidscale false 4K)
    scaleforcedwindow = 1.5,            	-- scaling when rendered on a forced window (vidscale false 4K)
    ...
    fadeduration = 200,                 	-- duration of fade out in ms, 0 = no fade (case "don't show on mouse move")
    ...
    layout = "topbar",                 -- set thumbnail layout
    title = "${filename/no-ext}",       	-- string compatible with property-expansion to be shown as OSC title
    ...
    titlefont = "sf pro text",          -- font used for the title above OSC and in the window controls bar
	...
	seekbarColorIndex = 2,				-- Default OSC seekbar color (oscPalette)
    ...
    showChapters = true, 				-- Toggle chapters on / off
...
local osc_styles = {
    ...
    timecodeL = "{\\blur0\\bord0\\1c&H" .. white .. "&\\3c&H000000&\\fs13\\fn" .. user_opts.titlefont .. "}",
    timecodeR = "{\\blur0\\bord0\\1c&H" .. white .. "&\\3c&H000000&\\fs13\\fn" .. user_opts.titlefont .. "}",
