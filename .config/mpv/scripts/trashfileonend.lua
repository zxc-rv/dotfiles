...
local settings = {
	...
	accepted_reasons = {
		...
		["redirect"] = false, --Happens with playlists and similar. Details see MPV_END_FILE_REASON_REDIRECT in the C API.
		["unknown"] = false, --Unknown. Normally doesn't happen, unless the Lua API is out of sync with the C API.
	},
}
