...
local user_opts = {
	-- general settings --
	language = "ru", -- en:English, chs:Chinese, pl:Polish, jp:Japanese
	...
	showonpause = false, -- whether to show to osc when paused
	...
	windowcontrols_title = "${filename/no-ext}", -- same as title but for windowcontrols
	...
	titlefontsize = 25, -- the font size of the title text
	dynamictimeformat = true, -- don't show hh on times less than 1 hour
	chapterformat = "Глава: %s", -- chapter print format for seekbar-hover. "no" to disable
...
local language = {
	...
	["ru"] = {
		welcome = "{\\fs24\\1c&H0&\\1c&HFFFFFF&}Закиньте фаилы или ссылки для воспроизведения.", -- this text appears when mpv starts
		off = "Выкл",
		na = "н/д",
		none = "Не доступно",
		video = "Видео",
		audio = "Аудио",
		subtitle = "Субтитры",
		nosub = "Нет доступных субтитров",
		noaudio = "Нет доступных аудиодорожек",
		track = " дорожки:",
		playlist = "Плэйлист",
		nolist = "Пустой плэйлист.",
		chapter = "Глава",
		nochapter = "Нет глав.",
		ontop = "Закрепить окно",
		ontopdisable = "Открепить окно",
		loopenable = "Включить зацикливание",
		loopdisable = "Выключить зацикливагие",
	},
	["chs"] = {
